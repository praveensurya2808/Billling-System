...
class Bill_App:
    ...
    def __init__(self, root):
        self.root = root
        self.root.geometry("1730x1000+0+0")
        self.root.title("WALMART")
        bg_color = "#0BB5FF"
        title = Label(self.root, text="WALMART", bd=10, relief=GROOVE, bg=bg_color, fg="#003151",
        ...
        # ======Juices Frame=======
        F2 = LabelFrame(self.root, text="Juices", bd=10, relief=GROOVE, font=("times new roman", 15, "bold"),
                        fg="#191970", bg=bg_color)
        F2.place(x=10, y=180, width=325, height=600)

        sprite_lbl1 = Label(F2, text="Sprite", font=("times new roman", 16, "bold"), bg=bg_color, fg="#003151").grid(
            row=0, column=0, padx=10, pady=10, sticky="w")
        sprite_txt = Entry(F2, width=10, textvariable=self.sprite, font=("times new roman", 16, "bold"), bd=5,
                           relief=SUNKEN).grid(row=0, column=1, padx=10, pady=10)

        thumbsup_lbl1 = Label(F2, text="Thumbs Up", font=("times new roman", 16, "bold"), bg=bg_color,
                              fg="#003151").grid(row=1, column=0, padx=10, pady=10, sticky="w")
        thumbsup_txt = Entry(F2, width=10, textvariable=self.thumbsup, font=("times new roman", 16, "bold"), bd=5,
                             relief=SUNKEN).grid(row=1, column=1, padx=10, pady=10)

        coco_cola_lbl1 = Label(F2, text="Coco Cola", font=("times new roman", 16, "bold"), bg=bg_color,
                               fg="#003151").grid(row=2, column=0, padx=10, pady=10, sticky="w")
        coco_cola_txt = Entry(F2, width=10, textvariable=self.coco_cola, font=("times new roman", 16, "bold"), bd=5,
                              relief=SUNKEN).grid(row=2, column=1, padx=10, pady=10)

        sveen_Up_lbl1 = Label(F2, text="7 Up", font=("times new roman", 16, "bold"), bg=bg_color, fg="#003151").grid(
            row=3, column=0, padx=10, pady=10, sticky="w")
        sveen_Up_txt = Entry(F2, width=10, textvariable=self.sveen_Up, font=("times new roman", 16, "bold"), bd=5,
                             relief=SUNKEN).grid(row=3, column=1, padx=10, pady=10)

        Dukes_lbl1 = Label(F2, text="Dukes Soda", font=("times new roman", 16, "bold"), bg=bg_color, fg="#003151").grid(
            row=4, column=0, padx=10, pady=10, sticky="w")
        Dukes_txt = Entry(F2, width=10, textvariable=self.Dukes, font=("times new roman", 16, "bold"), bd=5,
                          relief=SUNKEN).grid(row=4, column=1, padx=10, pady=10)

        mirinda_lbl1 = Label(F2, text="Mirinda", font=("times new roman", 16, "bold"), bg=bg_color, fg="#003151").grid(
            row=5, column=0, padx=10, pady=10, sticky="w")
        mirinda_txt = Entry(F2, width=10, textvariable=self.mirinda, font=("times new roman", 16, "bold"), bd=5,
                            relief=SUNKEN).grid(row=5, column=1, padx=10, pady=10)
        maaza_lbl1 = Label(F2, text="Maaza", font=("times new roman", 16, "bold"), bg=bg_color, fg="#003151").grid(
            row=6, column=0, padx=10, pady=10, sticky="w")
        maaza_txt = Entry(F2, width=10, textvariable=self.maaza, font=("times new roman", 16, "bold"), bd=5,
                            relief=SUNKEN).grid(row=6, column=1, padx=10, pady=10)

        #  =======Chips Frame=======

        F3 = LabelFrame(self.root, text="Chips", bd=10, relief=GROOVE, font=("times new roman", 15, "bold"),
                        fg="#191970", bg=bg_color)
        F3.place(x=340, y=180, width=325, height=380)

        lays_lbl1 = Label(F3, text="Lays", font=("times new roman", 16, "bold"), bg=bg_color, fg="#003151").grid(row=0,
                                                                                                                 column=0,
                                                                                                                 padx=10,
                                                                                                                 pady=10,
                                                                                                                 sticky="w")
        lays_txt = Entry(F3, width=10, textvariable=self.lays, font=("times new roman", 16, "bold"), bd=5,
                         relief=SUNKEN).grid(row=0, column=1, padx=10, pady=10)

        doritos_lbl1 = Label(F3, text="Doritos", font=("times new roman", 16, "bold"), bg=bg_color, fg="#003151").grid(
            row=1, column=0, padx=10, pady=10, sticky="w")
        doritos_txt = Entry(F3, width=10, textvariable=self.doritos, font=("times new roman", 16, "bold"), bd=5,
                            relief=SUNKEN).grid(row=1, column=1, padx=10, pady=10)

        pringles_lbl1 = Label(F3, text="Pringles", font=("times new roman", 16, "bold"), bg=bg_color,
                              fg="#003151").grid(row=2, column=0, padx=10, pady=10, sticky="w")
        pringles_txt = Entry(F3, width=10, textvariable=self.pringles, font=("times new roman", 16, "bold"), bd=5,
                             relief=SUNKEN).grid(row=2, column=1, padx=10, pady=10)

        peppy_lbl1 = Label(F3, text="Peppy", font=("times new roman", 16, "bold"), bg=bg_color, fg="#003151").grid(
            row=3, column=0, padx=10, pady=10, sticky="w")
        peppy_txt = Entry(F3, width=10, textvariable=self.peppy, font=("times new roman", 16, "bold"), bd=5,
                          relief=SUNKEN).grid(row=3, column=1, padx=10, pady=10)

        kurkure_lbl1 = Label(F3, text="Kurkure", font=("times new roman", 16, "bold"), bg=bg_color, fg="#003151").grid(
            row=4, column=0, padx=10, pady=10, sticky="w")
        kurkure_txt = Entry(F3, width=10, textvariable=self.kurkure, font=("times new roman", 16, "bold"), bd=5,
                            relief=SUNKEN).grid(row=4, column=1, padx=10, pady=10)

        wheels_lbl1 = Label(F3, text="Wheels", font=("times new roman", 16, "bold"), bg=bg_color, fg="#003151").grid(
            row=5, column=0, padx=10, pady=10, sticky="w")
        wheels_txt = Entry(F3, width=10, textvariable=self.wheels, font=("times new roman", 16, "bold"), bd=5,
                           relief=SUNKEN).grid(row=5, column=1, padx=10, pady=10)

        # ========Chocolate============

        F4 = LabelFrame(self.root, text="Chocolate", bd=10, relief=GROOVE, font=("times new roman", 15, "bold"),
                        fg="#191970", bg=bg_color)
        F4.place(x=670, y=180, width=325, height=380)

        silk_lbl1 = Label(F4, text="Silk Oreo", font=("times new roman", 16, "bold"), bg=bg_color, fg="#003151").grid(
            row=0, column=0, padx=10, pady=10, sticky="w")
        silk_txt = Entry(F4, width=10, textvariable=self.silk, font=("times new roman", 16, "bold"), bd=5,
                         relief=SUNKEN).grid(row=0, column=1, padx=10, pady=10)

        toblerone_lbl1 = Label(F4, text="Toblerone", font=("times new roman", 16, "bold"), bg=bg_color,
                               fg="#003151").grid(row=1, column=0, padx=10, pady=10, sticky="w")
        toblerone_txt = Entry(F4, width=10, textvariable=self.toblerone, font=("times new roman", 16, "bold"), bd=5,
                              relief=SUNKEN).grid(row=1, column=1, padx=10, pady=10)

        kitkat_lbl1 = Label(F4, text="Kit kat", font=("times new roman", 16, "bold"), bg=bg_color, fg="#003151").grid(
            row=2, column=0, padx=10, pady=10, sticky="w")
        kitkat_txt = Entry(F4, width=10, textvariable=self.kitkat, font=("times new roman", 16, "bold"), bd=5,
                           relief=SUNKEN).grid(row=2, column=1, padx=10, pady=10)

        snicker_lbl1 = Label(F4, text="Snickers", font=("times new roman", 16, "bold"), bg=bg_color, fg="#003151").grid(
            row=3, column=0, padx=10, pady=10, sticky="w")
        snicker_txt = Entry(F4, width=10, textvariable=self.snicker, font=("times new roman", 16, "bold"), bd=5,
                            relief=SUNKEN).grid(row=3, column=1, padx=10, pady=10)

        star_lbl1 = Label(F4, text="5 Star", font=("times new roman", 16, "bold"), bg=bg_color, fg="#003151").grid(
            row=4, column=0, padx=10, pady=10, sticky="w")
        star_txt = Entry(F4, width=10, textvariable=self.star, font=("times new roman", 16, "bold"), bd=5,
                         relief=SUNKEN).grid(row=4, column=1, padx=10, pady=10)

        fuse_lbl1 = Label(F4, text="Fuse", font=("times new roman", 16, "bold"), bg=bg_color, fg="#003151").grid(row=5,
                                                                                                                 column=0,
                                                                                                                 padx=10,
                                                                                                                 pady=10,
                                                                                                                 sticky="w")
        fuse_txt = Entry(F4, width=10, textvariable=self.fuse, font=("times new roman", 16, "bold"), bd=5,
                         relief=SUNKEN).grid(row=5, column=1, padx=10, pady=10)
        ...
        a1_lbl1 = Label(F6, text="Total Juice Price", bg=bg_color, fg="#003151",
                        font=("times new roman", 14, "bold")).grid(row=0, column=0, padx=20, pady=1, sticky="w")
        a1_txt = Entry(F6, width=18, textvariable=self.juice_price, font="arial 10 bold", bd=7, relief=SUNKEN).grid(
            row=0, column=1, padx=10, pady=1)

        a2_lbl1 = Label(F6, text="Total Chips Price", bg=bg_color, fg="#003151",
                        font=("times new roman", 14, "bold")).grid(row=1, column=0, padx=20, pady=1, sticky="w")
        a2_txt = Entry(F6, width=18, textvariable=self.chips_price, font="arial 10 bold", bd=7, relief=SUNKEN).grid(
            row=1, column=1, padx=10, pady=1)

        a3_lbl1 = Label(F6, text="Total Chocolate Price", bg=bg_color, fg="#003151",
                        font=("times new roman", 14, "bold")).grid(row=2, column=0, padx=20, pady=1, sticky="w")
        a3_txt = Entry(F6, width=18, textvariable=self.chocolate_price, font="arial 10 bold", bd=7, relief=SUNKEN).grid(
            row=2, column=1, padx=10, pady=1)

        b1_lbl1 = Label(F6, text="Juice Tax", bg=bg_color, fg="#003151", font=("times new roman", 14, "bold")).grid(
            row=0, column=2, padx=20, pady=1, sticky="w")
        b1_txt = Entry(F6, width=18, textvariable=self.juice_tax, font="arial 10 bold", bd=7, relief=SUNKEN).grid(row=0,
                                                                                                                  column=3,
                                                                                                                  padx=10,
                                                                                                                  pady=1)

        b2_lbl1 = Label(F6, text="Chips Tax", bg=bg_color, fg="#003151", font=("times new roman", 14, "bold")).grid(
            row=1, column=2, padx=20, pady=1, sticky="w")
        b2_txt = Entry(F6, width=18, textvariable=self.chips_tax, font="arial 10 bold", bd=7, relief=SUNKEN).grid(row=1,
                                                                                                                  column=3,
                                                                                                                  padx=10,
                                                                                                                  pady=1)
        ...
        total = Button(btn_A, command=self.total, text="Total", bg="#03C04A", fg="White", bd=5, pady=15, width=11,
        ...
        clear = Button(btn_A, text="Clear", command=self.clear_data, bg="#03C04A", fg="White", bd=5, pady=15, width=11,
                       font="arial 13 bold").grid(row=0, column=2, padx=5, pady=5)
        Exit = Button(btn_A, text="Exit", command=self.Exit_app, bg="#03C04A", fg="White", bd=5, pady=15, width=11,
    ...
    def total(self):
        ...
        self.j_z_p = (self.maaza.get() * self.maaza_price)
    ...
    def bill_area(self):
        if self.c_name.get() == "" or self.c_phon.get() == "":
            ...
            if self.maaza.get() != 0:
                self.txtarea.insert(END, f"\n Maaza\t\t{self.maaza.get()}\t\t{self.maaza_price}\t\t{self.j_z_p}")
            # =========chips bill generate======
            if self.lays.get() != 0:
